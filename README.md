...
**Desenvolvedor RPA · Python · Aprendendo Data Science**
...
I'm an **RPA Developer** at **CESUPE / TJMG**, designing and maintaining Python robots for the judicial system of Minas Gerais — Selenium automations for eProc and RUPE/JPE, CustomTkinter desktop apps, web dashboards, and integrations with corporate APIs (Jira, Google Sheets, Supabase).

Currently transitioning to **Data Science**, studying from scratch in focused morning sessions. Pandas, statistics, and ML are the immediate focus; NLP applied to legal text is the natural long-term specialization.

### What I build

- **RPA bots** — Selenium + Python to eliminate repetitive work in judicial systems (eProc, RUPE/JPE), with GUI, batch processing, pause/resume, and auditable logs
- **Internal tools** — desktop apps (CustomTkinter) and web apps (Streamlit) used daily by court staff
- **Executive dashboards** — delivery metrics, aging, and SLAs (Jira API + Google Sheets + frontend)
- **In-house design system** — AURA: dark palette, consistent typography, unified identity across robots

### Stack

**Languages:** Python · SQL · JavaScript  
**Automation:** Selenium · PyAutoGUI · PyInstaller  
**GUI:** CustomTkinter · Tkinter  
**Web:** Streamlit · Tailwind CSS  
**Data:** Pandas · SQLite · Supabase  
**Integrations:** Jira REST API · Google Sheets API · Google Apps Script
